...
class Interface {
    ...
    mudaCorQuadrado(quadrados) {
        ...
        if (this.vencedor !== null) {
            quadrados[0].style.background = '#FF9933';
            quadrados[1].style.background = '#FF9933';
            quadrados[2].style.background = '#FF9933';
        }
        else if (this.jogador === 'X') {
            quadrados[0].style.background = '#40E0D0';
            console.log(quadrados[0].style.background);
        }
        else if (this.jogador === 'O')  {
            quadrados[0].style.background = '#3a2';
            console.log(quadrados[0].style.background);
        }
    }
